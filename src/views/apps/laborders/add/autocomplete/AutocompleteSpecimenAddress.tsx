...
const AutocompleteSpecimenAddress = () => {
  ...
  const onAddressChange = (value: AddressType) => {
    ...
    labOrderSpecimenCopy.SpecimenAddress1 = value.address1
    labOrderSpecimenCopy.SpecimenAddress2 = value.address2
    labOrderSpecimenCopy.SpecimenCity = value.city
    labOrderSpecimenCopy.SpecimenState = value.state
    labOrderSpecimenCopy.SpecimenZip = value.zip
...
export default AutocompleteSpecimenAddress;
