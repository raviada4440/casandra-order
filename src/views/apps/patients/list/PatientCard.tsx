...
const PatientCard = ({ totalPatients, totalFhirPatients }: { totalPatients: number; totalFhirPatients: number }) => {
  // Hooks
  ...
  const data = [
    ...
    {
      title: totalFhirPatients,
      subtitle: 'Patients from FHIR Connection',
      icon: 'ri-wallet-line'
    }
  ]
