...
const CatalogCard = ({ labs, noOfCatalogs, totalTests, testsWithOrderloinc }: { labs: number, noOfCatalogs: number; totalTests: number; testsWithOrderloinc: number }) => {
  // Hooks
  ...
  const data = [
    ...
    {
      title: testsWithOrderloinc,
      subtitle: 'Tests with Order Loinc',
