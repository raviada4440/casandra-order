...
const CernerLaunch = () => {
  ...
  useEffect(() => {
    if(data && data.length > 0) {
      ...
      signIn('cerner', undefined, { aud: fhirUrl as string, launch: launchToken as string}).then((res) => {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            Cerner user is being authenticated and authorized. Please wait...
          </Typography>
        </CardContent>
        <CardActions>
          <Box sx={{ width: '100%' }}>
